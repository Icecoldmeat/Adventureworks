...
GO
EXEC sp_addextendedproperty N'MS_Description', N'changes', 'SCHEMA', N'Person', 'TABLE', N'Person', NULL, NULL
GO
EXEC sp_addextendedproperty N'test', N'test', 'SCHEMA', N'Person', 'TABLE', N'Person', NULL, NULL
GO
